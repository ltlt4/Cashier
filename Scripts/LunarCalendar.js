...
(function () {
	...
	*/
    ...
    function solarToLunar(_year, _month, _day) {
        ...
        var CapYaer = lunarDate[0].toString().split('')
        var CapYaerList = new Array
        for (var i = 0; i < CapYaer.length; i++) {
            switch (parseInt(CapYaer[i])) {
                case 0:
                    CapYaerList.push('零')
                    break;
                case 1:
        ...
        var res = {
            ...
            lunarYearName: CapYaerList.join('')+'年',
            lunarMonth: lunarDate[1] + 1,
            lunarDay: lunarDate[2],
            lunarMonthName: lunarMonthName,
            lunarDayName: DATA.dateCn[parseInt(lunarDate[2]) - 1],
